...
=======
        ...
        isTablet: false,
        testSizes: function (width) {
>>>>>>> 554ec5042a4bb57bbcfa2d4015f9887fb81c61a0
            ...
            var i = e(this), d = i[y](); et.hideDelay> 0 && i.add(d).on("mouseleave", function () {
                ...
                var n, u, p, v, E, S, x, _, D, P, B; if (i.is(T)) return l; window[m](at), nt.each(function () {
                    ...
                    case "zoom":ot = b, d[a](et[t]), i.animate( {
                            ...
                            ot = l
                        })); break; case "instant":default:d[a](et[t]), i.show()
                }return l
            }).on(f, function () {
                return i.is(T) ? (i[W](), d[h](et[t]), i[q]("." + et[t])[h](et[t]), i[q](j)[W](), l) :l
            }).on(B, function () {
...
(function ($) {
    $.fn.simpleSlider = function (o) {
        var d = {
            width:1500, height:500, animSpeed:500, animType:'fade', timeOut:10000, useCaptions:true, responsive:true
        }; var p = $.extend(d, o); var $a = this, $b = $a.find('ul'), $c = $b.children('li'), $d, c = $c.length; var ci, ni; var rw, rr, rh; if (p.timeOut < 1000) {
            p.timeOut = 1000;
        }return $a.each(function () {
            var a = function () {
                $c.addClass('simpleSlider-slide'); if (p.responsive) {
                    b();
                }else {
                    e();
                }if (p.useCaptions) {
                    ...
                    g();
                }else if (p.animType == 'push-left' || p.animType == 'push-right' || p.animType == 'push-down' || p.animType == 'push-up') {
                    h();
                }else if (p.animType == 'slide-left' || p.animType == 'slide-right' || p.animType == 'slide-down' || p.animType == 'slide-up') {
                    i();
                }else if (p.animType == 'zoom-in' || p.animType == 'zoom-out') {
                    j();
                }else {
                    k();
                ...
                $c.css( {
                    ...
                    'height':h, 'max-width':w, 'position':'relative'
                });
            }; var b = function () {
                rw = $a.outerWidth(), rr = rw / p.width, rh = rr * p.height; n('100%', rh); if (rw < p.width) {
                    n(rw, rh);
                }$(window).resize(function () {
                    rw = $a.outerWidth(), rr = rw / p.width, rh = rr * p.height; n('100%', rh);
                    if (p.animType == 'push-left') {
                        n(rw, rh);
                        $d.css( {
                            'width':rw, 'height':rh, 'overflow':'hidden', 'position':'relative'
                        }); $b.css( {
                            'width':rw * c, 'height':rh, 'left':0
                        });
                    }else if (p.animType == 'push-right') {
                        n(rw, rh);
                        $d.css( {
                            'width':rw, 'height':rh, 'overflow':'hidden', 'position':'relative'
                        }); $b.css( {
                            'width':rw * c, 'height':rh, 'right':rw * (c - 1)
                        });
                    }else if (p.animType == 'push-up') {
                        n(rw, rh);
                        $d.css( {
                            'width':rw, 'height':rh, 'overflow':'hidden', 'position':'relative'
                        }); $b.css( {
                            'width':rw, 'height':rh * c, 'top':0
                        });
                    }else if (p.animType == 'push-down') {
                        n(rw, rh);
                        $d.css( {
                            'width':rw, 'height':rh, 'overflow':'hidden', 'position':'relative'
                        }); $b.css( {
                            'width':rw, 'height':rh * c, 'bottom':rh * (c - 1)
                        });
                    }
                });
            }; var e = function () {
                ...
                $c.find('img').each(function () {
                    var $i = $(this); var link = $i.attr('data-link'); if (link) {
                        $i.wrap('<a href="' + link + '"></a>');
                    }
                });
            }; var f = function () {
                $c.find('img').each(function () {
                    var $i = $(this); var caption = $i.attr('alt'); if (caption) {
                        $i.after('<p class="simpleSlider-caption">' + caption + '</p>');
                    }
                });
            }; var o = function () {
                ...
                if (p.animType == 'push-left' || p.animType == 'push-up') {
                    o();
                }else if (p.animType == 'push-right' || p.animType == 'push-down') {
                    q();
                }$d = $('<div class="simpleSlider-' + p.animType + '-wrapper"></div>'); if (p.responsive && (rw < p.width)) {
                    if (p.animType == 'push-left') {
                        $d.css( {
                            'width':rw, 'height':rh, 'overflow':'hidden', 'position':'relative'
                        }); $b.css( {
                    ...
                    if (p.animType == 'push-left') {
                        $d.css( {
                            'width':p.width, 'height':p.height, 'overflow':'hidden', 'position':'relative'
                        }); $b.css( {
                            'width':p.width * c, 'height':p.height, 'left':0
                        });
                    }else if (p.animType == 'push-right') {
                        $d.css( {
                            'width':p.width, 'height':p.height, 'overflow':'hidden', 'position':'relative'
                        }); $b.css( {
                            'width':p.width * c, 'height':p.height, 'right':p.width * (c - 1)
                        });
                    }else if (p.animType == 'push-up') {
                        $d.css( {
                            'width':p.width, 'height':p.height, 'overflow':'hidden', 'position':'relative'
                        }); $b.css( {
                            'width':p.width, 'height':p.height * c, 'top':0
                        });
                    }else if (p.animType == 'push-down') {
                        $d.css( {
                            'width':p.width, 'height':p.height, 'overflow':'hidden', 'position':'relative'
                        }); $b.css( {
                            'width':p.width, 'height':p.height * c, 'bottom':p.height * (c - 1)
                        });
                    }
                }if (p.animType == 'push-left' || p.animType == 'push-up') {
                    $c.css( {
                    ...
                    $c.css( {
                        'float':'right', 'position':'relative', 'display':'list-item'
                    });
                }$d.prependTo($a); $b.appendTo($d);
            }; var i = function () {
                if (p.animType == 'slide-left' || p.animType == 'slide-up') {
                    $c.css( {
                        'float':'left', 'position':'relative', 'display':'list-item'
                    });
                }else if (p.animType == 'slide-right' || p.animType == 'slide-down') {
                    $c.css( {
                        'float':'right', 'position':'relative', 'display':'list-item'
                    });
                }$c.each(function (index) {
                ...
                if (p.responsive && (rw < p.width)) {
                    var sw = rw; var sh = rh;
                }else {
                    var sw = p.width; var sh = p.height;
                }if (p.animType == 'fade') {
                    $c.eq(ci).fadeOut(p.animSpeed, function () {
                        $c.eq(ni).fadeIn(p.animSpeed, function () {
                            r();
                        });
                    });
                }else if (p.animType == 'push-left') {
                    $b.animate( {
                        'left':- ni * sw
                    }, p.animSpeed, function () {
                        r();
                    });
                }else if (p.animType == 'push-right') {
                    $b.animate( {
                ...
                }else if (p.animType == 'slide-left') {
                    $c.eq(ci).animate( {
                        'left':- sw
                    }, p.animSpeed, function () {
                        $c.eq(ci).css('display', 'none'); $c.eq(ni).fadeIn(p.animSpeed); $c.eq(ci).animate( {
                            'left':0
                        }, p.animSpeed); r();
                    });
                }else if (p.animType == 'slide-right') {
                    $c.eq(ci).animate( {
                        'right':- sw
                    }, p.animSpeed, function () {
                        $c.eq(ci).css('display', 'none'); $c.eq(ni).fadeIn(p.animSpeed); $c.eq(ci).animate( {
                ...
                }else if (p.animType == 'zoom-in') {
                    $c.eq(ci).find('img:first-child').animate( {
                        'height':2 * sh, 'width':2 * sw, 'top':sh / - 2
                    }, p.animSpeed); $c.eq(ci).fadeOut(p.animSpeed, function () {
                        $c.eq(ni).fadeIn(p.animSpeed, function () {
                            $c.eq(ci).find('img:first-child').animate( {
                                'height':sh, 'width':sw, 'top': 0
                            }, p.animSpeed); r();
                        });
                    });
                }else if (p.animType == 'zoom-out') {
                    $c.eq(ci).find('img:first-child').animate( {
                        'height':0, 'width':0, 'top':sh / 2
                    }, p.animSpeed); $c.eq(ci).fadeOut(p.animSpeed, function () {
                        $c.eq(ni).fadeIn(p.animSpeed, function () {
                            $c.eq(ci).find('img:first-child').animate( {
                                'height':sh, 'width':sw, 'top':0
                    ...
                    $c.eq(ci).css('display', 'none'); $c.eq(ni).css('display', 'block'); r();
                }
            }; a();
        });
    }
...
/*******
 * G.R.I.D JS (Awesomes jQuery plugins)
 ******/
(function ($) {
    $.grid = {
...
=======
            ...
            if (params.anim == "fade") {
                $wrapper.fadeOut('fast', function () {
                    ...
                    if (params.onOpen) {
                        $wrapper.fadeIn(params.speed, function(){ params.onOpen() });
                    }
                    else {
                        $wrapper.fadeIn(params.speed);
                    }
                            ...
                            $w.animate( {
                                ...
                                $w.animate( {
                                    ...
                                    $w.animate( {
                                        ...
                                        $w.animate( {
                                            left: 0
                                        }, params.speed, function(){ params.onFinish() });
                                    });
                                });
                            });
                        });
